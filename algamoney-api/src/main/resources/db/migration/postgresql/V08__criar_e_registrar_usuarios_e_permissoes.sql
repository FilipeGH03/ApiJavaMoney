...
SELECT setval(pg_get_serial_sequence('usuario', 'codigo'), (SELECT MAX(codigo) FROM usuario), true);
SELECT setval(pg_get_serial_sequence('permissao', 'codigo'), (SELECT MAX(codigo) FROM permissao), true);
