...
import com.algaworks.algamoney.algamoney_api.exceptionhandler.AlgamoneyExceptionHandler;
...
import com.algaworks.algamoney.algamoney_api.service.LancamentoService;
...
public class LancamentoResource {
    ...
    public ResponseEntity<Lancamento> criar(@Valid @RequestBody Lancamento lancamento, HttpServletResponse response){
        Lancamento lancamento_salvo = lancamentoService.salvarLancamento(lancamento);
        publisher.publishEvent(new RecursoCriadoEvent(this, response, lancamento_salvo.getCodigo()));
